...
fn search(arena: std.mem.Allocator, opts: Options, tool: Tool) ![]const u8 {
    ...
    return renderSearch(arena, query, try common.sortedMatches(arena, common.arrayField(result, "matches")));
}

fn open(arena: std.mem.Allocator, opts: Options, tool: Tool) ![]const u8 {
    return common.openRecord(arena, "research", "docs/research/<name>.md", opts.arg1, tool);
}
...
fn append(arena: std.mem.Allocator, opts: Options, tool: Tool) ![]const u8 {
    return common.appendRecord(arena, "research", "docs/research/<name>.md -- \"## Finding\\n\\n...\"", opts.arg1, opts.arg2, tool);
}
