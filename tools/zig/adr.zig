...
//!         {"action":"rename", "path":"docs/adrs/0001-x.md", "slug":"new-name"}
//! Output: {"ok":true, ...}
...
fn tool_main(input: []const u8, out: *lib.Out) !void {
    ...
    return lib.fail(out, "action must be list, create, open, search, append, update, status, or rename");
}
...
fn rename(obj: std.json.Value, out: *lib.Out) !void {
    return records_grep.renameRecord(out, obj, dir, index_path, true, "an ADR");
}
