...
const host_tested_helpers = [_][]const u8{ "alphaxiv_client", "arena_match", "cards", "commit_logic", "compare_logic", "gh_url", "hashline", "kernel_magic", "manifest_scan", "search_parse" };
