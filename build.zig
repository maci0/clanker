...
const host_tested_helpers = [_][]const u8{ "alphaxiv_client", "arena_match", "cards", "commit_logic", "compare_logic", "gh_url", "goal_store", "hashline", "kernel_magic", "log_view", "manifest_scan", "memory_embed", "search_parse", "webui_addon_logic" };
