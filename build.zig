...
const host_tested_helpers = [_][]const u8{ "advisor_logic", "agency_sync_logic", "alphaxiv_client", "arena_match", "autolearn_logic", "autoresearch_logic", "calculator_logic", "cards", "cas_lock_record", "commit_logic", "compare_logic", "config_logic", "doc_scaffold", "feedback_logic", "flat_json", "gauntlet_logic", "gh_url", "goal_store", "graph_listing", "hashline", "kernel_magic", "llm_budget", "log_view", "manifest_scan", "memory_embed", "model_reply", "model_stats_logic", "notifications_logic", "patch_logic", "plugin_config_logic", "providers_logic", "research_queries", "rewind_logic", "run_plan_logic", "schedule_cron", "schedule_logic", "search_parse", "session_export_logic", "sessions_logic", "skills_logic", "spill_logic", "strip_xml", "symbolic_regression_logic", "thinking_logic", "webui_addon_logic", "workflows_logic", "write_goal_logic" };
