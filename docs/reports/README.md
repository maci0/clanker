...
- [Every config validation error is printed twice, once by the startup dotenv probe](bugs/2026-08-24-config-validation-errors-print-twice.md) — Resolved
...
- [an unreadable or oversize improvements.jsonl reads as no history, disabling the improve loop's dedup and revert gates](bugs/2026-08-23-improve-history-read-failure-reads-as-empty.md) — Resolved
