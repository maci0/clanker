...
<!-- inventory:bug:start -->
- [Parallel worker sandbox omitted the session grant, failing the session_search capability eval and stalling improve-self](bugs/2026-08-21-worker-sandbox-missing-session-grant.md) — Resolved
