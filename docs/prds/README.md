...
| [0043](0043-external-coding-agent-driver-acp-client-headless-fallback.md) | External coding-agent driver (ACP client, headless fallback) | Shipped | Draft; driver is not built yet — phases name files to create |
