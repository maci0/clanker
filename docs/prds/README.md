...
| [0032](0032-mcp-client-bridge.md) | MCP client bridge | In progress | deepseek-code.com audit; needs a new registry dispatch kind |
| [0033](0033-agent-presets.md) | Agent presets | In progress | deepseek-code.com audit; supersedes the Feynman "role prompt files" note |
